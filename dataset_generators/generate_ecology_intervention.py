#!/usr/bin/env python3
"""
Generate Interventional Data for Ecology Dataset (Coral Ecology SCM)

Interventions allowed on L, E, X, S, P (light, temperature, chlorophyll, salinity, pH).
Saves:
- interventional_datasets/ecology_interventional_BO.pkl
- interventional_datasets/ecology_interventional_CBO.pkl  
"""
...
def main():
    print("Generating Ecology Interventional Datasets")
    print("=" * 50)
    
    # Load configuration and data
    config, feature_params, df, sem_equations, model_results = load_ecology_config()
    ...
    bo_path = 'interventional_datasets/ecology_interventional_BO.pkl'
    ...
    cbo_path = 'interventional_datasets/ecology_interventional_CBO.pkl'
    ...
    print("\n" + "="*50)
    print("ECOLOGY INTERVENTIONAL DATA GENERATION COMPLETE")
    print("="*50)
