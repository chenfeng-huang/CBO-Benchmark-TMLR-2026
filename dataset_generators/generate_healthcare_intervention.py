#!/usr/bin/env python3
"""
Generate interventional data for the healthcare dataset.

This script generates interventional datasets in .pkl format for the
healthcare dataset to support BO and CBO optimization algorithms.
"""
...
def load_psa_config():
    """Load healthcare dataset configuration and data."""
...
def save_interventional_data(bo_data, cbo_data):
    """Save interventional data to .pkl files for healthcare."""
...
def verify_data_format():
    """Verify the generated data format matches expected structure for healthcare."""
...
def main():
    """Main function to generate interventional data for healthcare."""

    print("Generating Interventional Data for healthcare Dataset")
    print("=" * 70)
    ...
    try:
        # Load configuration
        config, feature_params, df_filtered, sem_equations, model_results = load_psa_config()
        ...
        print("\n=== Summary ===")
        print("Successfully generated interventional data for healthcare:")
        print(f"✅ {bo_filename}")
