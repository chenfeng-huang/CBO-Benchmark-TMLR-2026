#!/usr/bin/env python3
"""
Generate Interventional Data for Synthetic Dataset

This script generates interventional datasets in .pkl format specifically for the
Synthetic dataset to support BO and CBO optimization algorithms.
"""
...
def load_completegraph_config():
    """Load Synthetic dataset configuration and data."""
...
def save_interventional_data(bo_data, cbo_data):
    """Save interventional data to .pkl files for Synthetic."""
...
def verify_data_format():
    """Verify the generated data format matches expected structure for Synthetic."""
...
def main():
    """Main function to generate interventional data for Synthetic."""

    print("Generating Interventional Data for Synthetic Dataset")
    print("=" * 70)
    ...
    try:
        # Load configuration
        config, feature_params, df_filtered, sem_equations, model_results = load_completegraph_config()
        ...
        print("\n=== Summary ===")
        print("Successfully generated interventional data for Synthetic:")
        print(f"✅ {bo_filename}")
