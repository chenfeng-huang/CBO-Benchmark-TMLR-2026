...
def fit_gp(
    ...
    # Use alternative prior specification for GPy compatibility
    try:
        ...
        # Fallback to direct InverseGamma construction
        prior_len = priors.InverseGamma(1., 1.)
        prior_sigma_f = priors.InverseGamma(4., .5)
        prior_lik = priors.InverseGamma(3., 1.)
