# Config for epidemiology experiment using a JSON numeric spec
...
def get_config():
  ...
  config.results_label = 'epidemiology'

  # Trials and data sizes
  config.n_trials = 100
  config.n_samples_obs = 200
  ...
  # Path to the epidemiology JSON spec (relative to project root or absolute)
  config.spec_path = 'epidemiology_spec.json'
