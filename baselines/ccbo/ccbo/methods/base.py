...
class BaseMethod(abc.ABC):
  ...
  def __init__(
    ...
    # Ensure best_initial_es is a tuple of variable names.
    if isinstance(initial_optimal_intervention_sets, list):
      self.best_initial_es = initial_optimal_intervention_sets[0]
    else:
      self.best_initial_es = initial_optimal_intervention_sets
