...
def get_real_sem(graph_name):
    ...
    if(graph_name=="CoralGraph"):
        ...
        # NOTE: CBO_Benchmark/configs/protein.yaml uses raw scales for PKC/PKA,
        # so we deliberately skip the per-column normalization that the original
        # HCBO ProteinGraph workflow applied to "A".
        task='min'
